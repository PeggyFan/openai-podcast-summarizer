...
def get_podcast_highlights(podcast_transcript):
  ...
  openai.api_key = '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'
  instructPrompt = """
  You are an experienced economic news reporter. Analyze the content of the podcast and suggest three areas of news that an user should explore that are relevant to the content of the episode:
